...
private val COLUMN_NAMES = arrayOf("Code", "ASCII", "Pattern", "Icon", "Line")
...
internal class TiBasicCharacterDefinitionsTableModel(
    ...
    fun entryAt(modelRow: Int): TiBasicCharacterDefinitionEntry = entries[modelRow]
    ...
    override fun getColumnClass(column: Int): Class<*> = when (column) {
        CHARACTER_CODE_COLUMN, CHARACTER_LINE_COLUMN -> Int::class.javaObjectType
    ...
    override fun getValueAt(row: Int, column: Int): Any? {
        ...
        return when (column) {
            ...
            CHARACTER_LINE_COLUMN -> entry.lineNumber
            else -> null
        }
    }
}
            ...
            TiBasicCharacterDefinitionEntry(
                ...
                icons = TiBasicCharacterIcons(
                    ...
                    colorVariants = colorAssignments
                        .asSequence()
                        .filter { assignment -> definition.code in assignment.codeRange }
