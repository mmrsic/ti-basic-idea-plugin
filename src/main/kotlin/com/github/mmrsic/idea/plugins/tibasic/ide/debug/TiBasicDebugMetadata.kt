...
internal object TiBasicDebugMetadata {
    ...
    const val toolWindowJoystickTitleKey = "debug.tool.window.joystick.title"
    const val toolWindowJoystickUnitKey = "debug.tool.window.joystick.unit"
    const val toolWindowJoystickPositionKey = "debug.tool.window.joystick.position"
    const val toolWindowJoystickXVariableKey = "debug.tool.window.joystick.x.variable"
    const val toolWindowJoystickYVariableKey = "debug.tool.window.joystick.y.variable"
